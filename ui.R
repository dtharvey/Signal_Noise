          ...
          withMathJax(),
            column(width = 6,
              ...
              column(
                width = 6,
                  align = "center",
                    plotOutput("introplot1", height = "550px")        
            ))), # close tabPanel
          ...
          column(width = 6,
            ...
            column(width = 6, align = "center",
                ...
                sliderInput("spectrum", "spectrum number", 
                            ...
                            value = 1, width = "250px",
                            ticks = FALSE),
                  sliderInput("lambda_signal", "signal wavelength",
                              min = 450, max = 900, step = 1,
                              value = 600, ticks = FALSE),
                  sliderInput("lambda_noise", "noise wavelengths",
                              min = 450, max = 900, step = 1, 
        ...
        column(width = 6,
          ...
          column(width = 6,
                ...
                sliderInput("sigavg", 
                  ...
                  plotOutput("activity3plot", height = "500px")
                  ))),
              ...
              align = "center",
                splitLayout(width = c("125px", "250px", "250px"),
                  ...
                  sliderInput("filtersize", "length of filter",
                        ...
                        plotOutput("activity4plot", height = "500px")
                  ))),
          ...
          column(width = 6,
                 ...
                 splitLayout(
                    ...
                    sliderInput("keep", "points to retain",
                            ...
                            plotOutput("activity5plot", height = "550px")
                            ))),
    ...
    tabPanel("Wrapping Up",
        column(width = 6,
          ...
          column(width = 6,
                  ...
                  plotOutput("wrapupplot2", height = "300px")
            ))) # close navbarpanel
